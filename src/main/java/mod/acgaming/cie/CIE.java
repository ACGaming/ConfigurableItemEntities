...
@Mod(modid = CIE.MODID, name = CIE.NAME, version = CIE.VERSION, acceptedMinecraftVersions = "[1.12.2]", dependencies = CIE.DEPENDENCIES)
public class CIE
{
    ...
    public static final String DEPENDENCIES = "required-after:mixinbooter;after:hardcorebuoy;after:itemphysic;after:realdrops;after:aquaacrobatics;after:potioncore";
